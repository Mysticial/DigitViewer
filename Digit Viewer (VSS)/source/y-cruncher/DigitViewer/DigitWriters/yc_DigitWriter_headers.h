/* yc_DigitWriter_headers.h - File Writer Object Interface
 * 
...
#pragma once
#ifndef _yc_DigitWriter_headers_H
#define _yc_DigitWriter_headers_H

...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
#define YC_DIGITWRITER_DEFAULT_BUFFER   ((ym_pL)64 << 20)
class DigitWriter{
public:
    DigitWriter();
    virtual ~DigitWriter    ();
    ...
    void    push    (const char *str,ym_pL digits);
     ...
     *  is very large.
     */
    virtual void    write   (char *str,ym_pL digits) = 0;
