...
#define ymi_CVN_rawd_to_u64d19_u1_SSE41(T,A){   \
    ...
    \
    _c0 = _mm_cvtsi32_si128(*(ym_u32*)((const char*)(A) +  0)); \
    _c0 = _mm_insert_epi32(_c0,*(ym_u32*)((const char*)(A) + 19),2);    \
    ...
    \
    \
    _a0 = _mm_loadu_si128((__m128i*)((const char*)(A) +  3));   \
    _a1 = _mm_loadu_si128((__m128i*)((const char*)(A) + 22));   \
    \
...
#define ymi_CVN_rawd_to_u64d19_u2_SSE41(T,A){   \
    ...
    _c0 = _mm_cvtsi32_si128(*(ym_u32*)((const char*)(A) +  0)); \
    _c0 = _mm_insert_epi32(_c0,*(ym_u32*)((const char*)(A) + 19),2);    \
    _c0 = _mm_insert_epi32(_c0,*(ym_u32*)((const char*)(A) + 38),1);    \
    _c0 = _mm_insert_epi32(_c0,*(ym_u32*)((const char*)(A) + 57),3);    \
    _c0 = _mm_and_si128(_c0,_MASK3);    \
    \
    _a1 = _mm_loadu_si128((__m128i*)((const char*)(A) + 22));   \
    ...
    \
    _a2 = _mm_loadu_si128((__m128i*)((const char*)(A) + 41));   \
    _c2 = _mm_and_si128(_c0,_MASK1);    \
    _c0 = _mm_srli_epi32(_c0,16);   \
    _c2 = _mm_mullo_epi16(_c2,_TEN1);   \
    _c0 = _mm_add_epi16(_c0,_c2);   \
    \
    _a3 = _mm_loadu_si128((__m128i*)((const char*)(A) + 60));   \
