...
void ymo_print_label(const char *label,ym_pL label_width,const char *value,char color){
    ...
    ym_pL label_length = strlen(label);
    ymo_print_astr(label);

    while (label_length < label_width){
        ymo_print_astr(" ");
        label_length++;
    }
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
YM_NO_INLINE void ymo_error(const char *msg){
    ymo_print_astr("\n\n");
    ymo_set_color_R(1);
    ymo_print_astr(msg);
    ymo_set_color_W();
...
YM_NO_INLINE void ymo_error_wstr(const wchar_t *msg){
    ymo_print_wstr(L"\n\n");
    ymo_set_color_R(1);
    ymo_print_wstr(msg);
    ymo_set_color_W();
...
YM_NO_INLINE void ymo_warning(const char *msg){
    ymo_print_astr("\n");
    ymo_set_color_R(1);
    ymo_print_astr(msg);
    ymo_set_color_W();
}
YM_NO_INLINE void ymo_warning_wstr(const wchar_t *msg){
    ymo_print_wstr(L"\n");
    ymo_set_color_R(1);
    ymo_print_wstr(msg);
    ymo_set_color_W();
...
#ifdef YMS_MAX_THREAD_K
    ym_kL max_thread_k = YMS_MAX_THREAD_K;
#else
    ym_kL max_thread_k = 8;
#endif

    ym_kL out = (ym_kL)ymo_prompt_uL(L"k = ",0,max_thread_k);
    return out;
}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
