...
struct ym_heap{
    static void* malloc(ym_heap *ah,ym_pL bytes,ym_pL align){
...
static inline char* ym_ah_malloc_ch(ym_heap *ah,ym_pL cnt){
    return (char*)ym_heap::malloc(ah,cnt * sizeof(char),sizeof(char));
}
static inline wchar_t* ym_ah_malloc_wch(ym_heap *ah,ym_pL cnt){
    return (wchar_t*)ym_heap::malloc(ah,cnt * sizeof(wchar_t),sizeof(wchar_t));
}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
