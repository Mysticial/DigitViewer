...
void ym_sba_init(ym_heap *ah,ym_sba *T){
    ...
    T->len = 0;
    T->alen = 16;
    T->buffer = (char*)ym_heap::malloc(ah,T->alen * sizeof(char),sizeof(char));
    if (T->buffer == NULL)
        ym_allocfail();
}
...
void ym_sba_push_char(ym_heap *ah,ym_sba *T,char ch){
    ...
    if (T->len == T->alen){
        ...
        char *V = (char*)ym_heap::malloc(ah,T->alen * sizeof(char),sizeof(char));
        if (V == NULL)
            ym_allocfail();
...
void ym_sbw_init(ym_heap *ah,ym_sbw *T){
    ...
    T->len = 0;
    T->alen = 16;
    T->buffer = (wchar_t*)ym_heap::malloc(ah,T->alen * sizeof(wchar_t),sizeof(wchar_t));
    if (T->buffer == NULL)
        ym_allocfail();
}
...
void ym_sbw_push_char(ym_heap *ah,ym_sbw *T,wchar_t ch){
    ...
    if (T->len == T->alen){
        T->alen <<= 1;
        wchar_t *V = (wchar_t*)ym_heap::malloc(ah,T->alen * sizeof(wchar_t),sizeof(wchar_t));
//        if (V == NULL){
//            ym_allocfail();
//        }
