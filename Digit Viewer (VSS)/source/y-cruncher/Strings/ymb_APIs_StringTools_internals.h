...
wchar_t* ymb_str_w_copy_n(ym_heap *ah,const wchar_t *A){
    ...
    wchar_t *out = (wchar_t*)ym_heap::malloc(ah,L * sizeof(wchar_t),sizeof(wchar_t));
    if (out == NULL)
        return NULL;
...
wchar_t* ymb_str_ww_append_n(ym_heap *ah,const wchar_t *A,const wchar_t *B){
    ...
    wchar_t *out = (wchar_t*)ym_heap::malloc(ah,allocL * sizeof(wchar_t),sizeof(wchar_t));
    if (out == NULL)
        return NULL;
...
wchar_t* ymb_str_build_path_(ym_heap *ah,const wchar_t *path,const wchar_t *name){
    ...
    ym_pL oL = pL + nL + 2;
    wchar_t *newpath = (wchar_t*)ym_heap::malloc(ah,oL * sizeof(wchar_t),0);
