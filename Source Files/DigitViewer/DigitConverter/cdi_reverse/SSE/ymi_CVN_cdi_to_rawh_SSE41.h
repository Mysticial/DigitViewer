...
#ifndef _ymi_CVN_cdi_to_rawh_SSE41_H
#define _ymi_CVN_cdi_to_rawh_SSE41_H

#define ymi_CVN_c32i_to_rawh_u1_SSE41(T,A){ \
    register const __m128i _MASK = _mm_set1_epi16(0xf0);    \
    \
    register __m128i _a0;   \
    register __m128i _b0;   \
    \
    _a0 = _mm_loadl_epi64((const __m128i*)((const u64_t*)(A) + 0)); \
    \
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
#define ymi_CVN_c32i_to_rawh_u2_SSE41(T,A){ \
    register const __m128i _MASK = _mm_set1_epi16(0xf0);    \
    \
    ...
    _a0 = _mm_shuffle_epi32(_a0,78);    \
    \
    _mm_storeu_si128((__m128i*)(T) + 1,_a0);    \
    _mm_storeu_si128((__m128i*)(T) + 0,_a1);    \
}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
#define ymi_CVN_c32i_to_rawh_u3_SSE41(T,A){ \
    register const __m128i _MASK = _mm_set1_epi16(0xf0);    \
    \
    ...
    _a0 = _mm_shufflehi_epi16(_a0,27);  \
    _a1 = _mm_shufflehi_epi16(_a1,27);  \
    _mm_storeu_si128((__m128i*)(T) + 2,_a1);    \
    _a2 = _mm_shufflehi_epi16(_a2,27);  \
    _a3 = _mm_shufflehi_epi16(_a3,27);  \
    _mm_storeu_si128((__m128i*)(T) + 0,_a3);    \
    \
    _a0 = _mm_shuffle_epi32(_a0,78);    \
    _mm_storeu_si128((__m128i*)(T) + 3,_a0);    \
    _a2 = _mm_shuffle_epi32(_a2,78);    \
    _mm_storeu_si128((__m128i*)(T) + 1,_a2);    \
}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
