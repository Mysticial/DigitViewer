/* yc_YCDReader_headers.h - .ycd Reader Object
 * 
...
#pragma once
#ifndef _yc_YCDReader_headers_H
#define _yc_YCDReader_headers_H

...
public:
    ...
    YCDReader(std::wstring path,bool raw = false,ym_pL buffer_size = YC_DIGITREADER_DEFAULT_BUFFER);
    ...
    ym_fL               get_digits_per_file () const;
    void                print_paths         () const;
    ym_pL               get_num_paths       () const;

private:
    std::wstring name;                  //  File name
    ym_pL max_id_length;                //  Max length of id
    std::vector<std::wstring> paths;    //  Full path (including the id #)

    int radix;                          //  Radix of the digits. (10 or 16)
    void (*fp_convert)(char*,const ym_u64*,ym_pL);  //  Function pointer for digit conversion.
    ...
    ym_fL blocks_per_file;              //  # of 64-bit blocks per file
    ...
    void load_new_file(std::wstring path,ym_uL id);
    void set_current_file(ym_uL id);
};
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
