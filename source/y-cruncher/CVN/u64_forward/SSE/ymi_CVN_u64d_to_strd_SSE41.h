 ...
 *      u64d_to_strd    =   Decimal Integer -> Decimal String
 *      SSE41           =   SSE4.1 Instruction Set
 * 
 * 
 *      This file is virtually identical to "ymi_CVN_u64d_to_rawd_SSE41.h".
 *  Go there for documentation.
 */

#ifndef _ymi_CVN_u64d_to_strh_SSE41_H
#define _ymi_CVN_u64d_to_strh_SSE41_H

#define ymi_CVN_u64d19_to_strd_u1_SSE41(T,A){   \
    ...
    const __m128i _DECSHIFT = _mm_set1_epi8('0');   \
    \
    ...
    \
    /*  Add ASCII offsets.  */  \
    _o0 = _mm_add_epi8(_o0,_DECSHIFT);  \
    _o1 = _mm_add_epi8(_o1,_DECSHIFT);  \
    _o2 = _mm_add_epi8(_o2,_DECSHIFT);  \
    \
    /*  Store to destination.   */  \
    _mm_storeu_si128((__m128i*)(T) + 0,_o0);    \
    _mm_storeu_si128((__m128i*)(T) + 1,_o1);    \
    _i0 = _mm_cvtsi128_si64(_o2);   \
    *((ym_u32*)(T) +  8) = (ym_u32)_i0; \
    *((ym_u16*)(T) + 18) = (ym_u16)(_i0 >> 32); \
}
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
